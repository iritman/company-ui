  ...
  return (
    <>
      <Col xs={24}>
        <ValueLabel
          title={
            type === "mission" ? Words.work_time_daily : Words.vacation_daily
          }
      ...
      <Col xs={24}>
        <ValueLabel
          title={
            type === "mission" ? Words.work_time_timely : Words.vacation_timely
          }
      ...
      <Col xs={24}>
        <ValueLabel
          title={
            type === "mission" ? Words.work_time_total : Words.vacation_total
          }
