...
import { ceremonyRequestReportFileConfig as fileConfig } from "./../../../../../config.json";
...
const UserOfficialCheckCeremonyRequestNewReportModal = ({
  isOpen,
  onOk,
  onCancel,
  request,
  ...
  useMount(async () => {
    setRecord(initRecord(request.RequestID));
...
export default UserOfficialCheckCeremonyRequestNewReportModal;
