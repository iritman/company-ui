...
import { ceremonyRequestReportFilesUrl } from "../../../../../config.json";
import NewReportModal from "./user-official-check-ceremony-request-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckCeremonyRequestReportsModal = ({
  request,
  isOpen,
  onCancel,
  onRegReport,
                          ...
                          {report.Files.length > 0 && (
                            <Col xs={24}>
                              {report.Files.map((file) => (
                                <a
                                  key={file.FileID}
                                  href={`${ceremonyRequestReportFilesUrl}/${file.FileName}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <Tag
...
export default UserOfficialCheckCeremonyRequestReportsModal;
