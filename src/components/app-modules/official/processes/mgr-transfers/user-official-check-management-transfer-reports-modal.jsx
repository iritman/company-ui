...
import { managementTransferReportFilesUrl } from "../../../../../config.json";
import NewReportModal from "./user-official-check-management-transfer-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckManagementTransferReportsModal = ({
  transfer,
  isOpen,
  onCancel,
  onRegReport,
                          ...
                          {report.Files.length > 0 && (
                            <Col xs={24}>
                              {report.Files.map((file) => (
                                <a
                                  key={file.FileID}
                                  href={`${managementTransferReportFilesUrl}/${file.FileName}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <Tag
...
export default UserOfficialCheckManagementTransferReportsModal;
