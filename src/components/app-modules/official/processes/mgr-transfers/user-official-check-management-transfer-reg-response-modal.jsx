...
import { managementTransferActionFileConfig as fileConfig } from "./../../../../../config.json";
...
const UserOfficialCheckManagementTransferRegResponse = ({
  isOpen,
  onOk,
  onCancel,
  transfer,
        ...
        <Row gutter={[5, 1]} style={{ marginLeft: 1 }}>
          <Col xs={24} md={12}>
            <SwitchItem
              ...
              initialValue={true}
              checkedTitle={Words.approve_transfer}
              unCheckedTitle={Words.cancel_transfer}
...
export default UserOfficialCheckManagementTransferRegResponse;
