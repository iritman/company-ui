...
import { managementTransferReportFileConfig as fileConfig } from "./../../../../../config.json";
...
const UserOfficialCheckManagementTransferNewReportModal = ({
  isOpen,
  onOk,
  onCancel,
  transfer,
  ...
  useMount(async () => {
    setRecord(initRecord(transfer.TransferID));
  ...
  const handleSubmit = async () => {
    ...
    if (data.error) {
      ...
      const rec = { ...record };
      rec.TransferID = transfer.TransferID;
      rec.Files = files;
      setRecord(rec);
...
export default UserOfficialCheckManagementTransferNewReportModal;
