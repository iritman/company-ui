...
import { dismissalReportFileConfig as fileConfig } from "./../../../../../config.json";
import { onUpload } from "../../../../../tools/upload-tools";

const schema = {
  DismissalID: Joi.number(),
...
const UserOfficialCheckDismissalNewReportModal = ({
  isOpen,
  onOk,
  onCancel,
  dismissal,
  ...
  useMount(async () => {
    setRecord(initRecord(dismissal.DismissalID));
  ...
  const handleSubmit = async () => {
    ...
    if (data.error) {
      ...
      const rec = { ...record };
      rec.DismissalID = dismissal.DismissalID;
      rec.Files = files;
      setRecord(rec);
...
export default UserOfficialCheckDismissalNewReportModal;
