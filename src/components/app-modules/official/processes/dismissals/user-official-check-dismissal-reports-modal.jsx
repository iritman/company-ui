...
import { dismissalReportFilesUrl } from "../../../../../config.json";
import NewReportModal from "./user-official-check-dismissal-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckDismissalReportsModal = ({
  dismissal,
  isOpen,
  onCancel,
  onRegReport,
...
export default UserOfficialCheckDismissalReportsModal;
