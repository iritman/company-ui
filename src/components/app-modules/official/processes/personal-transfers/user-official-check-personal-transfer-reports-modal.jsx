...
import NewReportModal from "./user-official-check-personal-transfer-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckPersonalTransferReportsModal = ({
  transfer,
  isOpen,
  onCancel,
  onRegReport,
...
export default UserOfficialCheckPersonalTransferReportsModal;
