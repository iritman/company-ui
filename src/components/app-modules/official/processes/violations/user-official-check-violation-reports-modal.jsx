...
import { violationReportFilesUrl } from "../../../../../config.json";
import NewReportModal from "./user-official-check-violation-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckViolationReportsModal = ({
  violation,
  isOpen,
  onCancel,
  onRegReport,
                          ...
                          {report.Files.length > 0 && (
                            <Col xs={24}>
                              {report.Files.map((file) => (
                                <a
                                  key={file.FileID}
                                  href={`${violationReportFilesUrl}/${file.FileName}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <Tag
...
export default UserOfficialCheckViolationReportsModal;
