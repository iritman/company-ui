...
import { checkoutReportFilesUrl } from "../../../../../config.json";
import NewReportModal from "./user-official-check-checkout-new-report-modal";

const { Text } = Typography;

const UserOfficialCheckCheckoutReportsModal = ({
  checkout,
  isOpen,
  onCancel,
  onRegReport,
                          ...
                          {report.Files.length > 0 && (
                            <Col xs={24}>
                              {report.Files.map((file) => (
                                <a
                                  key={file.FileID}
                                  href={`${checkoutReportFilesUrl}/${file.FileName}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <Tag
...
export default UserOfficialCheckCheckoutReportsModal;
