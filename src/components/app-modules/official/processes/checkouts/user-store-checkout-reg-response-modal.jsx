...
import { checkoutActionFileConfig as fileConfig } from "./../../../../../config.json";
...
const UserStoreCheckoutRegResponse = ({ isOpen, onOk, onCancel, checkout }) => {
...
export default UserStoreCheckoutRegResponse;
