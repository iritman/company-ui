...
import service from "../../../../services/official/timex/user-official-check-members-missions-service";
import {
  checkAccess,
  getColumns,
...
import SearchModal from "./user-official-check-members-missions-search-modal";
...
const UserOfficialCheckMembersMissions = ({ pageName }) => {
  const {
    progress,
    searched,
    setSearched,
...
export default UserOfficialCheckMembersMissions;
