...
import VacationCardexModal from "./user-official-check-vacation-cardex-modal";
import SearchModal from "./user-official-check-vacation-cardexes-search-modal";
...
const UserOfficialCheckVacationCardexesPage = ({ pageName }) => {
  const {
    progress,
    searched,
    setSearched,
...
export default UserOfficialCheckVacationCardexesPage;
