        ...
        <TabPane tab={Words.task_details} key="task-info">
          ...
          >
            ...
            <Descriptions.Item label={Words.registerar}>
              <Space>
                <MemberProfileImage fileName={RegPicFileName} size="small" />
                <Text
            ...
            <Descriptions.Item label={Words.reminder_date_time}>
              <Text style={{ color: Colors.green[6], fontSize: 13 }}>
                {utils.farsiNum(
                  `${utils.dayNameFromText(ReminderDate)} - ${utils.colonTime(
                    ReminderTime
                  )}`
                )}
              </Text>
            ...
            <Descriptions.Item label={Words.seen_in}>
              <Text style={{ color: valueColor, fontSize: 13 }}>
                {utils.farsiNum(
                  `${utils.dayNameFromText(SeenDate)} - ${utils.colonTime(
                    SeenTime
                  )}`
                )}
              </Text>
            ...
            <Descriptions.Item label={Words.delay_status}>
              <Text
                style={{
                  color: ReminderInfo.HasDelay ? Colors.red[6] : valueColor,
                  fontSize: 13,
                }}
              >
            ...
            <Descriptions.Item label={Words.done_status}>
              {DoneDate.length > 0 ? (
                <Space>
                  ...
                  <Text style={{ color: valueColor, fontSize: 13 }}>
                    {utils.farsiNum(
                      `${utils.dayNameFromText(DoneDate)} - ${utils.colonTime(
                        DoneTime
                      )}`
                    )}
                  </Text>
