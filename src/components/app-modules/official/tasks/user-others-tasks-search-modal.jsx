...
import service from "../../../../services/official/tasks/others-tasks-service";
...
const UserOthersTasksSearchModal = ({ isOpen, filter, onOk, onCancel }) => {
  const {
    progress,
    setProgress,
    record,
...
export default UserOthersTasksSearchModal;
