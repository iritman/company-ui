...
import service from "../../../../services/official/tasks/department-tasks-service";
import {
  checkAccess,
  GetSimplaDataPageMethods,
} from "../../../../tools/form-manager";
import DepartmentTaskModal from "./user-department-task-modal";
import SearchModal from "./user-department-tasks-search-modal";
...
const UserDepartmentTasksPage = ({ pageName }) => {
  const {
    progress,
    setProgress,
    searched,
...
export default UserDepartmentTasksPage;
