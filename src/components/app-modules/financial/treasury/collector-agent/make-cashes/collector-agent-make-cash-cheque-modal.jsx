...
const CollectorAgentMakeCashChequeModal = ({
  isOpen,
  selectedObject,
  agentID,
  currentCheques,
  ...
  useMount(async () => {
    ...
    try {
      const data = await service.getCheques(agentID);

      let selectable_cheques = data.Cheques.filter(
...
export default CollectorAgentMakeCashChequeModal;
