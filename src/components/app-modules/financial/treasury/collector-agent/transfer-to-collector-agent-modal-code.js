...
export const schema = {
  TransferID: Joi.number().required().label(Words.id),
  AgentID: Joi.number().min(1).required().label(Words.collector_agent),
  TransferDate: Joi.string().required().label(Words.hand_over_date),
