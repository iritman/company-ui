...
import {
  ...
  getNewButton,
  calculatePrice,
} from "./collector-agent-refund-modal-code";
import ChequeModal from "./collector-agent-refund-cheque-modal";

const { TabPane } = Tabs;

const formRef = React.createRef();

const CollectorAgentRefundModal = ({
  access,
  isOpen,
  selectedObject,
  onOk,
        ...
        {selectedObject === null && (
          <>
            ...
            {hasSaveApproveAccess && (
              <Popconfirm
                title={
                  Words.questions.sure_to_submit_approve_collector_agent_refund
                }
      ...
      >
        <Form ref={formRef} name="dataForm">
          <Row gutter={[5, 1]} style={{ marginLeft: 1 }}>
            ...
            {record.CollectorAgentID > 0 &&
              (!selectedObject || selectedObject.StatusID === 1) && (
                <Col xs={24}>
...
export default CollectorAgentRefundModal;
