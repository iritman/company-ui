...
import service from "./../../../../services/settings/timex-settings/security-guards-service";
...
const SecurityGuardModal = ({ isOpen, selectedObject, onOk, onCancel }) => {
  const {
    progress,
    setProgress,
    record,
...
export default SecurityGuardModal;
